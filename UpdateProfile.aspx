<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateProfile.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <asp:LoginView ID="LVProfile" runat="server">
        <AnonymousTemplate>
            This page has restricted access.
            Return to <asp:HyperLink ID="HyperLink1" NavigateUrl="~/Index.aspx" runat="server">My Cars</asp:HyperLink> or sign in.
        </AnonymousTemplate>
        <LoggedInTemplate>
